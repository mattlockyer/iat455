...
BlurEffect.prototype = {
  draw: function() {
    ...
    var kernelIndex = this.controls.Strength.value;
    switch (kernelIndex) {
      case 0: kernel = this.kernel3x3; break;
      case 1: kernel = this.kernel5x5; break;
      case 2: kernel = this.kernel7x7; break;
      case 3: kernel = this.kernel9x9; break;
    }
